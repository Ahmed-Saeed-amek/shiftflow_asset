...
public class UsersController : Controller
{
    ...
    private Task<List<MyWorkOrderRow>> BuildMyWorkOrderRowsAsync(string userId, bool showAll, DateTime? from = null, DateTime? to = null) =>
        MyWorkOrderRowBuilder.BuildAsync(_db, _loc, userId, showAll, from, to);
