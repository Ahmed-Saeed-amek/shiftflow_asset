...
public interface IAiInspectionToolFunctions
{
    ...
    Task<object> ListGroupsAsync(string userId, CancellationToken ct);
    Task<object> GetGroupDetailAsync(int groupId, string userId, CancellationToken ct);
    ...
    Task<object> CreateGroupAsync(string name, string? description, List<string>? memberUserIds, string userId, CancellationToken ct);
    Task<object> AddGroupMemberAsync(int groupId, string memberUserId, string userId, CancellationToken ct);
    Task<object> RemoveGroupMemberAsync(int groupId, string memberUserId, string userId, CancellationToken ct);
}
