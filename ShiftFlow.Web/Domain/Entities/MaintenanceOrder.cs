...
public class MaintenanceOrder
{
    ...
    // same pattern as InspectionOrder. Group assignment added specifically so OrderType.AssignmentMode
    // ("GroupOnly"/"Either") means something for direct-fix types too, not just survey-style ones.
