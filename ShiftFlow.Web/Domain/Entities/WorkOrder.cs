...
public class WorkOrder
{
    ...
    /// <summary>Set only on work orders auto-generated by a RecurringOrder schedule for a RequiresVendor order type — the single-asset, no-contract counterpart to SourceContractId. Exactly one of the two (or neither, for a manually-created work order) is ever set.</summary>
    public int? SourceRecurringOrderId{get;set;} public virtual RecurringOrder? SourceRecurringOrder{get;set;}
    /// <summary>The due date this occurrence represents — distinct from CreatedDate, which is when the row was actually inserted (can lag behind if the generator was down when the date arrived).</summary>
