...
namespace ShiftFlow.Web.Infrastructure.Migrations
{
    ...
    [Migration("20260912072949_ReviewFixes_OrderNumberSequenceAndIndexes")]
    partial class ReviewFixes_OrderNumberSequenceAndIndexes
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ShiftFlow.Domain.Entities.ContractAttachment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ShiftFlow.Domain.Entities.Group", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ShiftFlow.Domain.Entities.GroupAssetScope", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("GroupAssetScopes");
                });

            modelBuilder.Entity("ShiftFlow.Domain.Entities.GroupMember", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ShiftFlow.Domain.Entities.InspectionOrder", b =>
                {
                    ...
                    b.Property<int?>("SourceRecurringOrderId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("SourceRecurringOrderId");

                    b.HasIndex("Status");

                    b.ToTable("InspectionOrders", t =>
                        {
                            t.HasCheckConstraint("CK_InspectionOrder_ExactlyOneAssignee", "([AssignedToUserId] IS NOT NULL AND [AssignedToGroupId] IS NULL) OR ([AssignedToUserId] IS NULL AND [AssignedToGroupId] IS NOT NULL)");
                        });
                });
            ...
            modelBuilder.Entity("ShiftFlow.Domain.Entities.InspectionRunAsset", b =>
                {
                    ...
                    b.HasIndex("InspectionRunId", "AssetId")
                        .IsUnique();
            ...
            modelBuilder.Entity("ShiftFlow.Domain.Entities.MaintenanceOrder", b =>
                {
                    ...
                    b.HasIndex("SourceRecurringOrderId", "AssetId", "ScheduledDate")
                        .IsUnique()
                        .HasFilter("[SourceRecurringOrderId] IS NOT NULL");

                    b.ToTable("MaintenanceOrders", t =>
                        {
                            t.HasCheckConstraint("CK_MaintenanceOrder_ExactlyOneAssignee", "([AssignedToUserId] IS NOT NULL AND [AssignedToGroupId] IS NULL) OR ([AssignedToUserId] IS NULL AND [AssignedToGroupId] IS NOT NULL)");
                        });
                });
            ...
            modelBuilder.Entity("ShiftFlow.Domain.Entities.MaintenanceOrderPart", b =>
                {
                    ...
                    b.Property<decimal?>("UnitCostAtUsage")
                        .HasColumnType("decimal(12,2)");
            ...
            modelBuilder.Entity("ShiftFlow.Domain.Entities.OrderNumberSequence", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ShiftFlow.Domain.Entities.OrderType", b =>
                {
                    ...
                    b.Property<bool>("AllowsMultipleAssets")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("ShiftFlow.Domain.Entities.RecurringOrder", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("RecurringOrders", t =>
                        {
                            t.HasCheckConstraint("CK_RecurringOrder_ExactlyOneAssignee", "([AssignedToUserId] IS NOT NULL AND [AssignedToGroupId] IS NULL) OR ([AssignedToUserId] IS NULL AND [AssignedToGroupId] IS NOT NULL)");
                        });
                });

            modelBuilder.Entity("ShiftFlow.Domain.Entities.RecurringOrderAsset", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("RecurringOrderId", "AssetId")
                        .IsUnique();

                    b.ToTable("RecurringOrderAssets");
                });
            ...
            modelBuilder.Entity("ShiftFlow.Domain.Entities.SparePart", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ShiftFlow.Domain.Entities.SparePartAsset", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("SparePartId", "AssetId")
                        .IsUnique();

                    b.ToTable("SparePartAssets");
                });
            ...
            modelBuilder.Entity("ShiftFlow.Domain.Entities.GroupAssetScope", b =>
                {
                    ...
                    b.HasOne("ShiftFlow.Domain.Entities.Group", "Group")
                        .WithMany()
            ...
            modelBuilder.Entity("ShiftFlow.Domain.Entities.InspectionOrder", b =>
                {
                    b.HasOne("ShiftFlow.Domain.Entities.Group", "AssignedToGroup")
                        .WithMany()
                    ...
                    b.HasOne("ShiftFlow.Domain.Entities.RecurringOrder", "SourceRecurringOrder")
                        .WithMany()
                        .HasForeignKey("SourceRecurringOrderId")
                        .OnDelete(DeleteBehavior.Restrict);
                    ...
                    b.Navigation("SourceRecurringOrder");
                });
            ...
            modelBuilder.Entity("ShiftFlow.Domain.Entities.MaintenanceOrderPart", b =>
                {
                    ...
                    b.HasOne("ShiftFlow.Domain.Entities.SparePart", "SparePart")
                        .WithMany()
            ...
            modelBuilder.Entity("ShiftFlow.Domain.Entities.RecurringOrderAsset", b =>
                {
                    b.HasOne("ShiftFlow.Domain.Entities.Asset", "Asset")
                        .WithMany("RecurringOrderLinks")
                        .HasForeignKey("AssetId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ShiftFlow.Domain.Entities.RecurringOrder", "RecurringOrder")
                        .WithMany("AssetLinks")
            ...
            modelBuilder.Entity("ShiftFlow.Domain.Entities.Asset", b =>
                {
                    ...
                    b.Navigation("RecurringOrderLinks");

                    b.Navigation("SparePartLinks");
