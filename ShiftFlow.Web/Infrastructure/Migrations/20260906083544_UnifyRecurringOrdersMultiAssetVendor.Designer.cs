...
namespace ShiftFlow.Web.Infrastructure.Migrations
{
    ...
    [Migration("20260906083544_UnifyRecurringOrdersMultiAssetVendor")]
    partial class UnifyRecurringOrdersMultiAssetVendor
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ShiftFlow.Domain.Entities.MaintenanceOrder", b =>
                {
                    ...
                    b.ToTable("MaintenanceOrders", t =>
                        {
                            t.HasCheckConstraint("CK_MaintenanceOrder_ExactlyOneAssignee", "([AssignedToUserId] IS NOT NULL AND [AssignedToTeamId] IS NULL) OR ([AssignedToUserId] IS NULL AND [AssignedToTeamId] IS NOT NULL)");
                        });
                });
            ...
            modelBuilder.Entity("ShiftFlow.Domain.Entities.RecurringOrder", b =>
                {
                    ...
                    b.ToTable("RecurringOrders", t =>
                        {
                            t.HasCheckConstraint("CK_RecurringOrder_ExactlyOneAssignee", "([AssignedToUserId] IS NOT NULL AND [AssignedToTeamId] IS NULL) OR ([AssignedToUserId] IS NULL AND [AssignedToTeamId] IS NOT NULL)");
                        });
                });
